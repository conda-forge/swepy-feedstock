About swepy-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/swepy-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/wino6687/SWEpy
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7150&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/swepy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `swepy` can be installed with `conda`:
...
It is possible to list all of the versions of `swepy` available on your platform with `conda`:
...
```
mamba search swepy --channel conda-forge
```
...
mamba repoquery search swepy --channel conda-forge

# List packages depending on `swepy`:
mamba repoquery whoneeds swepy --channel conda-forge

# List dependencies of `swepy`:
mamba repoquery depends swepy --channel conda-forge
```
